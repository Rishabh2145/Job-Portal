        ...
        <div className="w-2/3 gap-4 flex flex-col text-[14px]">
          <div className="flex justify-between items-center gap-4">
            <div className="flex flex-col gap-2">
              ...
              <div className="text-[12px] text-gray-600">Already have an account? <span className="text-indigo-500">Log in</span></div>
            </div>
            <div className="border-1 border-solid rounded-lg p-2 border-gray-400 text-gray-700 flex">Employee <Image src="/images/fi_chevron-down.png" alt="Arrow Down" width={20} height={10} className="ml-2" /></div>
          </div>
