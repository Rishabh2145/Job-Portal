            ...
            {jobs ? jobs.map((item, index) => (
                <div className="border border-gray-500 rounded-lg p-6" key={index}>
                    ...
                    <div className="mt-8 flex flex-col gap-4 px-4">
                        <div className="grid grid-cols-5 text-center font-bold flex justify-between">
                            <p>Name</p>
                            <p>Email</p>
                            <p>Profile</p>
                            <p>Status</p>
                        ...
                        {item ? item.Applied.map((applicant, ind) => (
                            <div className="grid grid-cols-5 text-center flex justify-between items-center" key={ind}>
                                ...
                                {<Popup trigger={<a className="text-blue-700 underline cursor-pointer">View Profile</a>}
                                    ...
                                    {close => (
                                        <div className="text-black bg-white p-4 rounded-lg shadow-lg w-200">
                                            ...
                                            <div className="p-4 flex flex-col gap-6">
                                                ...
                                                <div className="grid grid-cols-6 flex items-center gap-4 mt-4">
                                                    <p className="font-bold">Contact:</p>
                                                    <a className="col-span-2" href={`tel:${applicant.Applicants[0].contact}`}>{applicant.Applicants[0].contact}</a>
                                                    <p className="font-bold">Mobile:</p>
                                                    <a className="col-span-2" href={`tel:${applicant.Applicants[0].mobile}`}>{applicant.Applicants[0].mobile}</a>
                                                    <p className="font-bold">Institute:</p>
                                                    <p className="col-span-2">{applicant.Applicants[0].institute}</p>
                                                    <p className="font-bold">Institute Grade:</p>
                                                    <p className="col-span-2">{applicant.Applicants[0].instituteGrade}</p>
                                                    <p className="font-bold">School:</p>
                                                    <p className="col-span-2">{applicant.Applicants[0].school}</p>
                                                    <p className="font-bold">School Grade:</p>
                                                    <p className="col-span-2">{applicant.Applicants[0].schoolGrade}</p>
                                                    <p className="font-bold">Address:</p>
                                                    <p className="col-span-5">{applicant.Applicants[0].address}</p>
                                                    <p className="font-bold ">Why should we hire?:</p>
                                                    <p className="col-span-5">{applicant.ques}</p>
                                                </div>
