...
export default function Edit() {
    return (
        <main className="bg-white p-12 flex flex-col gap-8 m-4 rounded-xl">
            ...
            <form action='/dashboard/profile' className="grid grid-cols-2 flex justify-center items-center gap-6">
                ...
                <div className="flex w-full  gap-4 grid grid-cols-2">
                    <label htmlFor="address" className="flex items-center justify-end">Enter Grade (CGPA/Percent):</label>
