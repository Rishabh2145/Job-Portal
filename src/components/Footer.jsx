                ...
                <div className="flex flex-col gap-5 w-1/4 max-md:w-1/1">
                    ...
                    <form onSubmit={subscription.handleSubmit} className="flex flex-col gap-4 ">
                        ...
                        <input
                            ...
                            name="email"
                            id="email"
                            value={subscription.values.email}
                            onChange={subscription.handleChange}
                            className="border-1 border-solid border-gray-400 rounded-lg text-black-400 p-2 px-4"
                        />
                        <button type="submit" className="bg-[#309689] p-2 py-3 rounded-xl cursor-pointer hover:scale-105 transition-all">{isLoading? 'Loading...' : 'Subscribe Now'}</button>
                    </form>
                </div>
            </div>
