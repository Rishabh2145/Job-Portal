    ...
    return(
        <div className="flex flex-col mt-12 hover:scale-105 transition-all max-md:w-9/10 max-md:h-fit">
            <div className="static px-4 h-fit w-full">
                <h2 className="relative w-fit z-1 m-5 p-1 text-sm px-3 rounded-xl text-white bg-[#309689] max-md:m-2">{props.type}</h2>
                <Image
                    src={props.thumb}
                    alt={props.type}
                    height={props.height}
                    width={props.width}
                    className="rounded-3xl relative max-md:-top-12 -top-18"
                    
                    />
            </div>
            <div className="flex flex-col gap-4 w-9/10 p-2 px-4 relative max-md:-top-8 -top-10">
